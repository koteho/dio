...
public class FinanceStartPage extends Base{
	...
	public void checkAverageExchangeRates() {		
        ...
        for (int i=0; i < bankListSize; i++) {
        	...
        	//sorry, it's not elegant way but it's works and I doesn't have anything better           
        ...
        //Compare average values of purchase and sale rates with displayed value
        String result = compareExchangeRates(dataList, averagePurchaseValueCurrent, averageSaleValueCurrent) ? "passed" : "failed";
